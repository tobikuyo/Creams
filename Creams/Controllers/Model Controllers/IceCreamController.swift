...
class IceCreamController {
    ...
    var flavours: [IceCream] = [
        ...
        // MARK: Vanilla
        IceCream(name: "Vanilla", tagName: "classic", rating: 4.3, backgroundColor: UIColor(red: 207/255, green: 200/255, blue: 174/255, alpha: CGFloat(1)), labelColor: UIColor(red: 128/255, green: 124/255, blue: 109/255, alpha: CGFloat(1)), complimentaryColor: UIColor(red: 174/255, green: 181/255, blue: 207/255, alpha: CGFloat(1)), reasonToBuy: "Calcium is a key ingredient in ice cream and calcium-rich foods help keep your body strong and metabolism running well. A.K.A. eating ice cream = weight-loss diet. We would choose eating ice cream over running on the treadmill any day of the week!"),
        
        // MARK: Chocolate
        IceCream(name: "Chocolate", tagName: "milk", rating: 3.9, backgroundColor: UIColor(red: 127/255, green: 98/255, blue: 82/255, alpha: CGFloat(1)), labelColor: UIColor(red: 189/255, green: 147/255, blue: 123/255, alpha: CGFloat(1)), complimentaryColor: UIColor(red: 82/255, green: 111/255, blue: 127/255, alpha: CGFloat(1)), reasonToBuy: "Eating ice cream is essentially putting milk and cream into your body; these ingredients are great sources of calcium, vitamins A and D, riboflavin, and phosphorus. Depending on the flavor of ice cream, you may be getting even more nutrients. Flavors like vanilla bean and dark chocolate are loaded with antioxidants. Just imagine how healthy a chocolate-vanilla swirl ice cream is ?"),
        ...
        // MARK: Mint
        IceCream(name: "Mint", tagName: "refreshing", rating: 3.5, backgroundColor: UIColor(red: 112/255, green: 163/255, blue: 56/255, alpha: CGFloat(1)), labelColor: UIColor(red: 59/255, green: 85/255, blue: 29/255, alpha: CGFloat(1)), complimentaryColor: UIColor(red: 107/255, green: 56/255, blue: 163/255, alpha: CGFloat(1)), reasonToBuy: "Ice cream is a form of fermented dairy and fermented foods help protect your body from gastrointestinal and respiratory infections. You’ll see lactose (dairy) ingredients in a lot of probiotics that people take to help boost their immune systems because the stronger your gut and respiratory systems, the stronger your immune system will be. Let’s be real, eating a scoop of ice cream sounds much more exciting than taking a probiotic pill every day!"),
